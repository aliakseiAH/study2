...
// Пустое пространство на шахматной доске задается с помощью значения EMPTY. Также, у класса ChessBoard должен
// быть реализован метод print(), который выводит шахматную доску в консоль.
...
public class Task2 {
    public static void main(String[] args) {
        ...
        ChessBoard ch1  = new ChessBoard(chessPosition);
        ch1.print();
