...
public class Airplane {
    ...
    public static void compareAirplanes(Airplane a, Airplane b) {
        if (a.length > b.length) {
            System.out.println("Самолёт " + a.producer + " длиннее самолёта " + b.producer);
        } else if (a.length < b.length) {
            System.out.println("Самолёт " + b.producer + " длиннее самолёта " + a.producer);
        } else System.out.println("Самолёт " + b.producer + " равен самолёту " + a.producer);
    }
